...
<div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow ">
    ...
    <div className="flex flex-col items-center pb-10 mt-6">
        ...
        <span className="text-sm text-gray-500 dark:text-orange-600 m-2">4SN21AI000</span>
        <p className='my-2 mx-4 text-justify'>Adarsh S M's account is verified. Iris certifies their successful completion of A to Z Machine Learning Bootcamp on <b>02/05/2003</b> </p>
