...
export default function Internship() {
    ...
    const items = internshipItems.map((item, index) => (
        ...
        <div key={index} className={` mx-3 flex flex-col text-gray-700 items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 internship-card  ${visibleCards[index] ? 'visible' : ''}`}>
